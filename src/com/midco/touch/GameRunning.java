...
//			
			...
			canvas.drawArc(oval, aPointAddress.get(z).getSartP(), arcW, true, mPaint); //繪製圓弧  
    ...
    public void getTouchPoint()
	{
        ...
        for (int z = 0; z < TouchPoint; z++)
		{
            ...
            //記錄點坐標
			aPointAddress.add(new PointAddress(pointX, pointY,sartPoint));
